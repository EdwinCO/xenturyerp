			...
			<div class="col-md-6">
				<form method="post" action="add_user.php">
					...
					<div class="form-group clearfix">
						<button type="submit" name="add_user" class="btn btn-danger"style="margin-left:100px">Guardar</button>
					</div>
				</form>
				<form method="post" action="users.php">
					<button type="submit" name="back" class="btn btn-primary" style="margin-left:500px;margin-top:-85px;">Volver atras</button>
				</form>
			</div>
		</div>
    </div>
